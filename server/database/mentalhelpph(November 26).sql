...
--
-- Host: 127.0.0.1
-- Generation Time: Nov 26, 2024 at 03:34 PM
...
(1, 'Anton James', 'Genabio', '', 'jamesgenabio31@gmail.com', '090830958900', 'Psychologist', '$2y$10$KL4H5mBihZsgSryOErH.RO9mAh0YT8q9FmMVZcS8mLJ0hr7clxNpq', '900900', 2, 'http://localhost:3000/profile/1729451256002.png', 'I love ', '', 0, '', 'Accepted', 3500),
...
(8, 12, 22, '2024-11-24', '20:12:00', 'Active'),
...
--
ALTER TABLE `mental_health_professionals`
  MODIFY `professional_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=29;

--
-- AUTO_INCREMENT for table `messaging`
--
ALTER TABLE `messaging`
  MODIFY `messaging_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=71;
...
--
ALTER TABLE `patient_details`
  MODIFY `patient_details_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=24;
